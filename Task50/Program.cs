...
int lines = GetByteValueFromUser("Введите количество строк массива: ");
int columns = GetByteValueFromUser("Введите количество столбцов массива: ");
int[,] matrix = CreateMatrix(lines, columns);

Console.Write(PrintMatrix(matrix));

int horizontal = GetByteValueFromUser("Введите номер строки искомого элемента: ");
int vertical = GetByteValueFromUser("Введите номер столбца искомого элемента: ");
